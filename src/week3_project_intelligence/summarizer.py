...
from src.week3_project_intelligence.tools.intelligence_tools import (
    ProjectIntelligenceTools,
)
...
class ProjectSummarizer(BaseIntelligenceService):
    ...
    def generate_summary(
        self, project_id: str
    ) -> IntelligenceResult[ProjectSummary]:
        """
        ...
        final_summary = summary.model_copy(
            update={
                "sources_used": overview_data["sources"],
            }
        )
