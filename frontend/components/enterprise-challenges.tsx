    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="mt-16 grid items-center gap-8 lg:grid-cols-[1fr_auto_1fr] lg:gap-6">
          {/* Challenges */}
          <div
            className={`rounded-2xl border border-destructive/25 bg-card/60 p-6 backdrop-blur transition-all duration-700 md:p-8 ${
          ...
          >
            ...
            <ul className="mt-6 space-y-3">
              {challenges.map((item, index) => (
                <li
                  key={item}
                  className={`group flex items-start gap-3 rounded-lg border border-border/60 bg-background/50 px-4 py-3 transition-all duration-500 hover:border-destructive/40 ${
          ...
          <div className="flex items-center justify-center">
            <div
              className={`relative flex h-14 w-14 items-center justify-center rounded-full border border-primary/40 bg-primary/10 text-primary transition-all duration-700 ${
          ...
          {/* Solutions */}
          <div
            className={`relative rounded-2xl border border-primary/30 bg-card/70 p-6 backdrop-blur transition-all duration-700 md:p-8 ${
              visible ? "translate-y-0 opacity-100" : "translate-y-4 opacity-0"
            }`}
          ...
          >
            ...
            <ul className="relative mt-6 space-y-3">
              {solutions.map((item, index) => (
                <li
                  key={item}
                  className={`flex items-start gap-3 rounded-lg border border-border/60 bg-background/50 px-4 py-3 transition-all duration-500 hover:border-primary/50 hover:bg-background/70 ${
                    visible ? "translate-x-0 opacity-100" : "translate-x-3 opacity-0"
                  }`}
